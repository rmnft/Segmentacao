total_subclasses = [
    ...
    "trachea", "thyroid_gland", "small_bowel", "duodenum", "colon", "urinary_bladder", "prostate",
    "kidney_cyst_left", "kidney_cyst_right", "sacrum", "vertebrae_S1", "vertebrae_L5", "vertebrae_L4",
    ...
    "portal_vein_and_splenic_vein", "iliac_artery_left", "iliac_artery_right", "iliac_vein_left",
    "iliac_vein_right", "humerus_left", "humerus_right", "scapula_left", "scapula_right",
    ...
    "autochthon_right", "iliopsoas_left", "iliopsoas_right", "brain", "skull", "rib_right_4",
    "rib_right_3", "rib_left_1", "rib_left_2", "rib_left_3", "rib_left_4", "rib_left_5",
    "rib_left_6", "rib_left_7", "rib_left_8", "rib_left_9", "rib_left_10", "rib_left_11",
    "rib_left_12", "rib_right_1", "rib_right_2", "rib_right_5", "rib_right_6", "rib_right_7",
